...
<a name="cvsContact"></a>contact | [Contact Object](#contactObject) | **REQUIRED**. Provides metadata about the Curriculum Vitae. The metadata MAY be used by tooling as required.
...
Field Name | Type | Description
---|:---:|---
<a name="contactEmail"></a>email | `string[]` | **REQUIRED**. A primary contact email address for the applicant. The applicant MUST include a minimum of 1 email.
<a name="personMobile"></a>mobile | `string[]` | A mobile contact number for the applicant.